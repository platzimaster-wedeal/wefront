...
const URL_GET_PROBLEM = (id) =>
 `https://wedeal.herokuapp.com/api/v1/problems/${id}`;
const URL_GET_USER_PROBLEMS = (id) =>
...
export const getFullProblem = async (id) => {
 const data = await useRequestGetToken(URL_GET_FULL_PROBLEM(id));
 const resp = await data.json();
