...
import { useRequestUpdateForm, useRequestPatchForm } from '../../hooks/useRequestUpdateForm/useRequestUpdateForm'
...
const URL_GET_CONNECTIONS = (id) => `https://wedeal.herokuapp.com/api/v1/users/connections/${id}`
