...
import { useRequestGetToken, useRequestGet } from '../../hooks/useRequestGet/useRequestGet'

const URL_REGISTER = 'https://wedeal.herokuapp.com/api/v1/users'
const URL_GET = id => `https://wedeal.herokuapp.com/api/v1/users/${id}`
const URL_GET_FOLLOWERS = id => `https://wedeal.herokuapp.com/api/v1/follows/${id}/followers`
const URL_POST_FOLLOW = (idProfile, idUser) => `https://wedeal.herokuapp.com/api/v1/follows/${idProfile}/follow/${idUser}`
const URL_POST_SCORE = 'https://wedeal.herokuapp.com/api/v1/scores'
const URL_PUT_PROBLEM = id => `https://wedeal.herokuapp.com/api/v1/problems/${id}`
